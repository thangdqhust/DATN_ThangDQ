    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          <div class="form-group">
            <label class="control-label col-sm-2" for="name">Color:</label>
    ...
    $('#addColor').on('click',function(e){
      ...
      $.ajax({
        ...
        success:function(response){
         ...
         setTimeout(function () {toastr.success('color '+response.color+' has been added');},1000);
                var html=
                ...
                if (!checkNull(xhr.responseJSON.errors)) {
                  ...
                  $('p#sperrors').remove();
                  if(!checkNull(xhr.responseJSON.errors.color))
                  {
                    for (var i = 0; i < xhr.responseJSON.errors.color.length; i++) {
                      var html='<p id="sperrors" style="color:red">'+xhr.responseJSON.errors.color[i]+'</p>';
